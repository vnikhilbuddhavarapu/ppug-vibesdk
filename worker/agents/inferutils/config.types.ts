...
import { WORKERS_AI_MODELS_MASTER } from './workersAiModels';
...
export interface AgentConfig {
	...
	/** Model used by the Think coding agent (worker/agents/core/behaviors/think.ts). */
	think: ModelConfig;
}
...
export function credentialsToRuntimeOverrides(
	...
	const hasValidGateway =
		...
		isValidGatewayBaseUrl(credentials.aiGateway.baseUrl);
	return {
		...(hasKeys ? { userApiKeys } : {}),
		...(hasValidGateway
