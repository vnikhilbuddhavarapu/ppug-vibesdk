...
*/
const PLATFORM_AGENT_CONFIG: Omit<AgentConfig, 'think'> = {
...
const DEFAULT_AGENT_CONFIG: Omit<AgentConfig, 'think'> = {
	...COMMON_AGENT_CONFIGS,
	templateSelection: {
		name: AIModels.GEMINI_2_5_FLASH_LITE,
		max_tokens: 2000,
...
//======================================================================================
// Think agent config — always Workers AI for this event, regardless of
// PLATFORM_MODEL_PROVIDERS (that toggle only affects the phasic/legacy-agentic
// roles above). Constrained to the 7-model allowlist via AGENT_CONSTRAINTS.
//======================================================================================
const THINK_AGENT_CONFIG: Pick<AgentConfig, 'think'> = {
	think: {
		name: AIModels.GLM_5_3,
		reasoning_effort: 'medium',
		max_tokens: 32000,
		temperature: 1,
		fallbackModel: AIModels.DEEPSEEK_V4_FLASH,
	},
};
